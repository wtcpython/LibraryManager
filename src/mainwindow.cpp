...
void MainWindow::on_actionSaveFile_triggered()
{
    if (handler->getFileName() == nullptr)
    {
        QString fileName = QFileDialog::getSaveFileName(
            this, "Save Database", QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation) + "/data.db",
            "Database Files (*.db *.sqlite)");
...
void MainWindow::AddItem(AddItemDialog &dialog, bool isEdit)
{
...
void MainWindow::setBookItem(int rowIndex, Book_1 &book)
{
...
void MainWindow::setCDItem(int rowIndex, VideoCD_2 &cd)
{
...
void MainWindow::setPicItem(int rowIndex, Picture_2 &pic)
{
...
void MainWindow::on_mediaTypeBox_currentIndexChanged(int index)
{
    setTableItems();
}
...
void MainWindow::on_deleteItemButton_clicked()
{
    ...
    else
    {
        ...
        {
            QMessageBox::warning(this, QString("LibraryManager"), QString("ID：%1 删除成功！").arg(id),
                                 QMessageBox::Yes);
        }
        else
        {
...
void MainWindow::closeEvent(QCloseEvent *event)
{
    if (isSaveNeeded)
    {
        auto res = QMessageBox::warning(this, QString("LibraryManager"), QString("数据未保存，是否保存？"),
